...
import { ChevronRight, Cpu, Delete, Pencil, ScanLine, Trash, Trash2 } from "lucide-react-native";
...
const DeviceOptions = () => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      setHeaderSettings({
        heading: "Opciones del dispositivo",
        isIconVisible: false,
        ...
        <VStack space="lg">
          ...
          <TouchableRipple
            ...
            <HStack className="justify-between">
              <HStack space="md">
                <Icon as={Cpu} />
                <Text>Acerca del dispositivo</Text>
              </HStack>
              <RPressable onPress={() => NavigationService.navigate(AppRoutes.ScanQR)}>
          ...
          <TouchableRipple
            ...
            <HStack className="justify-between">
              <HStack space="md">
                <Icon as={Trash2} />
                <Text>Eliminar dispositivo</Text>
              </HStack>
              <RPressable onPress={() => NavigationService.navigate(AppRoutes.ScanQR)}>
